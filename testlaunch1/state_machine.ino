...
else if (abs((currentaltitude) - (previousaltitude)) > 5 && abs((previousaltitude) - (ppreviousaltitude)) > 5 && abs((currentaltitude) - (previousaltitude)) > abs((previousaltitude) - (ppreviousaltitude)) && apogee == true)
{
