...
#include "Timer.h" // weird timer voodoo?
...
Timer timer; // lets arduino know that timer is a thing that exists
...
//   message = message + ("Gyroscope_x: " + String(sensorValue.un.rawGyroscope.x) + "Gyroscope_y: " + String(sensorValue.un.rawGyroscope.y) + "Gyroscope_z: " + String(sensorValue.un.rawGyroscope.z));
//   send_xbee(message);
